...
export class PromptAudioTranscription119ColdStartAxonTest implements AxonTestInterface {
  ...
  results: AxonTestResultInterface = {
    ...
    inputAudioUrl: "images/cortex/speeches/spontaneous-speech-en-119.mp3",
    inputAudioDuration: 10.476
  };
  ...
  async run(): Promise<AxonTestResultInterface> {
    ...
    const expectedText = `Mostly uh family and then uh funeral service.`;
