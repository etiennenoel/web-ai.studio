...
@Injectable()
export class PromptAudioTranscription4167ColdStartAxonTest implements AxonTestInterface {
  id: AxonTestId = AxonTestId.PromptAudioTranscription4167ColdStart;
  ...
  results: AxonTestResultInterface = {
    ...
    inputAudioUrl: "images/cortex/speeches/spontaneous-speech-en-4167.mp3",
    inputAudioDuration: 17.748
  };
  ...
  async run(): Promise<AxonTestResultInterface> {
    ...
    const expectedText = `Only ask once. Uh the biggest insect where I come from in the United Kingdom. I don't really know. I think maybe it's something like a grasshopper. I can't think of anything bigger. Hmm, now I'm trying to decide whether a butterfly is an insect or not. Yeah, I'm not really sure.`;
