...
@Injectable()
export class PromptAudioTranscription5670ColdStartAxonTest implements AxonTestInterface {
  id: AxonTestId = AxonTestId.PromptAudioTranscription5670ColdStart;
  ...
  results: AxonTestResultInterface = {
    ...
    inputAudioUrl: "images/cortex/speeches/spontaneous-speech-en-5670.mp3",
    inputAudioDuration: 18.252
  };
  ...
  async run(): Promise<AxonTestResultInterface> {
    ...
    const expectedText = `I think that the kinds of tech that would make our lives better are any technology that helps us to live longer and be healthier. So, for example, maybe if my watch could tell me to stop eating so much sugar, I would be much happier.`;
