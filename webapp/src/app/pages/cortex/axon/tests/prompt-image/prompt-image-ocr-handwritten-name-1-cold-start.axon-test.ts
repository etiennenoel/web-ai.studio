...
@Injectable()
export class PromptImageOcrHandwrittenName1ColdStartAxonTest implements AxonTestInterface {
  id: AxonTestId = AxonTestId.PromptImageOcrHandwrittenName1ColdStart;
  ...
  results: AxonTestResultInterface = {
    ...
    inputImageDataUrl: "images/cortex/handwritten_names/TEST_0099.jpg"
  };
