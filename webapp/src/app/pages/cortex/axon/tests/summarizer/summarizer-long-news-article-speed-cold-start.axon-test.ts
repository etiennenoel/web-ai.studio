...
@Injectable()
export class SummarizerLongNewsArticleSpeedColdStartAxonTest implements AxonTestInterface {
  id: AxonTestId = AxonTestId.SummarizerLongNewsArticleSpeedColdStart;
