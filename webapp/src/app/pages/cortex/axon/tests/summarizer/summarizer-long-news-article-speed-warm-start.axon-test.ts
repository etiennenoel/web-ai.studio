...
@Injectable()
export class SummarizerLongNewsArticleSpeedWarmStartAxonTest implements AxonTestInterface {
  id: AxonTestId = AxonTestId.SummarizerLongNewsArticleSpeedWarmStart;
