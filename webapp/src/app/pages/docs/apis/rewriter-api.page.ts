      ...
      <div class="w-full p-6 md:p-12 pb-32 font-sans">
        ...
        <div class="mb-10">
          <nav class="text-sm font-medium text-slate-500 dark:text-slate-400 mb-6 flex items-center space-x-2">
            ...
            <span class="text-slate-900 dark:text-slate-200">Rewriter</span>
          </nav>
          ...
          <div class="mb-8">
            <div class="flex items-center gap-3 mb-2">
                ...
                <h1 class="text-4xl font-extrabold text-slate-900 dark:text-white tracking-tight">Rewriter API</h1>
              </div>
          ...
          <p class="text-base text-slate-600 dark:text-slate-400 leading-relaxed max-w-4xl">
            The Rewriter API is part of the Writing Assistance APIs. It is explicitly designed to transform and rephrase existing text while retaining the core meaning. Common use cases include adjusting the tone of an email (e.g., making it more formal), simplifying complex concepts ("Explain Like I'm 5"), or changing the length of a snippet.
          </p>
        </div>
        ...
        <div class="mb-12 max-w-4xl">
          ...
          <p class="text-slate-600 dark:text-slate-400 text-sm leading-relaxed mb-4">
            The API is exposed via the <code class="font-mono text-xs bg-slate-100 dark:bg-zinc-800 border border-slate-200 dark:border-zinc-700 text-slate-700 dark:text-slate-300 px-2 py-1 rounded">Rewriter</code> global object.
          </p>
        </div>
        ...
        <div class="mb-12 max-w-4xl">
          ...
          <div class="space-y-8">
            ...
            <div class="border border-slate-200 dark:border-zinc-800 rounded-xl overflow-hidden">
              <div class="bg-slate-50 dark:bg-zinc-900/50 px-5 py-3 border-b border-slate-200 dark:border-zinc-800">
                <h3 class="font-mono text-sm font-bold text-slate-900 dark:text-slate-200">
                  Rewriter.create(<span class="text-slate-500 font-normal">options?</span>)
                </h3>
              </div>
              <div class="p-5">
                <p class="text-slate-600 dark:text-slate-400 text-sm mb-4">
                  Initializes a rewriter object tailored with specific modifier constraints.
                </p>
                ...
                <ul class="list-disc pl-5 text-sm text-slate-600 dark:text-slate-400 space-y-2">
                  <li><code>tone</code>: The target register of the rewritten text (e.g., <code>"formal"</code>, <code>"casual"</code>).</li>
                  <li><code>format</code>: The structural output format (e.g., <code>"plain-text"</code>, <code>"markdown"</code>).</li>
                  <li><code>length</code>: The intended verbosity relative to the input (e.g., <code>"shorter"</code>, <code>"longer"</code>).</li>
                  <li><code>sharedContext</code>: Context defining the persona or global constraints for the rewriting task.</li>
                </ul>
              </div>
            </div>
            ...
            <div class="border border-slate-200 dark:border-zinc-800 rounded-xl overflow-hidden">
              <div class="bg-slate-50 dark:bg-zinc-900/50 px-5 py-3 border-b border-slate-200 dark:border-zinc-800">
                <h3 class="font-mono text-sm font-bold text-slate-900 dark:text-slate-200">
                  rewriter.rewriteStreaming(<span class="text-slate-500 font-normal">text, options?</span>)
                </h3>
              </div>
              <div class="p-5">
                <p class="text-slate-600 dark:text-slate-400 text-sm mb-4">
                  Applies the rewriting rules to the provided text and returns a <code>ReadableStream</code> of the transformed output.
                </p>
                <h4 class="text-xs font-bold text-slate-900 dark:text-slate-300 mb-2 uppercase tracking-wider">Parameters</h4>
                <ul class="list-disc pl-5 text-sm text-slate-600 dark:text-slate-400 space-y-2">
                  <li><code>text</code> (string): The existing source text to be rephrased.</li>
                  <li><code>options.context</code> (string): Ephemeral context specific to this individual rewrite operation.</li>
                </ul>
              </div>
            </div>
