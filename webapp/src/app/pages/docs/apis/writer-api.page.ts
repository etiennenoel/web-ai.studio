      ...
      <div class="w-full p-6 md:p-12 pb-32 font-sans">
        ...
        <div class="mb-10">
          <nav class="text-sm font-medium text-slate-500 dark:text-slate-400 mb-6 flex items-center space-x-2">
            ...
            <span class="text-slate-900 dark:text-slate-200">Writer</span>
          </nav>
          ...
          <div class="mb-8">
            <div class="flex items-center gap-3 mb-2">
                ...
                <h1 class="text-4xl font-extrabold text-slate-900 dark:text-white tracking-tight">Writer API</h1>
              </div>
          ...
          <p class="text-base text-slate-600 dark:text-slate-400 leading-relaxed max-w-4xl">
            The Writer API is part of the Writing Assistance APIs. It focuses on generating net-new material from a writing task prompt. Use it to expand short ideas or bullet points into full drafts, emails, or biographies while enforcing constraints like tone and format.
          </p>
        </div>
        ...
        <div class="mb-12 max-w-4xl">
          ...
          <p class="text-slate-600 dark:text-slate-400 text-sm leading-relaxed mb-4">
            The API is exposed via the <code class="font-mono text-xs bg-slate-100 dark:bg-zinc-800 border border-slate-200 dark:border-zinc-700 text-slate-700 dark:text-slate-300 px-2 py-1 rounded">Writer</code> global object.
          </p>
        </div>
        ...
        <div class="mb-12 max-w-4xl">
          ...
          <div class="space-y-8">
            ...
            <div class="border border-slate-200 dark:border-zinc-800 rounded-xl overflow-hidden">
              ...
              <div class="p-5">
                <p class="text-slate-600 dark:text-slate-400 text-sm mb-4">
                  Initializes a writer object configured with specific generation constraints.
                </p>
                ...
                <ul class="list-disc pl-5 text-sm text-slate-600 dark:text-slate-400 space-y-2">
                  <li><code>tone</code>: The stylistic register (e.g., <code>"formal"</code>, <code>"casual"</code>).</li>
                  <li><code>format</code>: The structural output format (e.g., <code>"plain-text"</code>, <code>"markdown"</code>).</li>
                  <li><code>length</code>: The intended verbosity (e.g., <code>"short"</code>, <code>"medium"</code>, <code>"long"</code>).</li>
                  <li><code>sharedContext</code>: Background information applied to all generation requests made by this object.</li>
                </ul>
              </div>
            </div>
            ...
            <div class="border border-slate-200 dark:border-zinc-800 rounded-xl overflow-hidden">
              ...
              <div class="p-5">
                <p class="text-slate-600 dark:text-slate-400 text-sm mb-4">
                  Executes the writing task and returns a <code>ReadableStream</code> of the newly drafted text.
                </p>
                <h4 class="text-xs font-bold text-slate-900 dark:text-slate-300 mb-2 uppercase tracking-wider">Parameters</h4>
                <ul class="list-disc pl-5 text-sm text-slate-600 dark:text-slate-400 space-y-2">
                  <li><code>task</code> (string): The description of what needs to be written (e.g., "A draft for an inquiry to my bank").</li>
                  <li><code>options.context</code> (string): Ephemeral context specific to this individual writing request.</li>
                </ul>
              </div>
            </div>
