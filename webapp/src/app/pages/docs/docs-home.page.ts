      ...
      <div class="max-w-5xl mx-auto w-full p-6 md:p-12 pb-32 font-sans">
        ...
        <div class="mb-16">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <a routerLink="/docs/get-started" class="!no-underline group block p-6 rounded-2xl bg-slate-50 dark:bg-[#161616]/50 border border-slate-200 dark:border-zinc-800/80 hover:border-indigo-300 dark:hover:border-indigo-500/50 hover:shadow-md transition-all">
            ...
            <a routerLink="/docs/check-availability" class="!no-underline group block p-6 rounded-2xl bg-slate-50 dark:bg-[#161616]/50 border border-slate-200 dark:border-zinc-800/80 hover:border-indigo-300 dark:hover:border-indigo-500/50 hover:shadow-md transition-all">
        ...
        <div class="mb-16">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <!-- Prompt API -->
            <a routerLink="/docs/prompt-api" class="!no-underline group flex flex-col p-5 rounded-2xl bg-[#ffffff] dark:bg-[#161616] border border-slate-200 dark:border-zinc-800 hover:border-slate-300 dark:hover:border-zinc-600 hover:shadow-sm transition-all h-full">
            ...
            <!-- Summarizer -->
            <a routerLink="/docs/summarizer" class="!no-underline group flex flex-col p-5 rounded-2xl bg-[#ffffff] dark:bg-[#161616] border border-slate-200 dark:border-zinc-800 hover:border-slate-300 dark:hover:border-zinc-600 hover:shadow-sm transition-all h-full">
            ...
            <!-- Writer -->
            <a routerLink="/docs/writer" class="!no-underline group flex flex-col p-5 rounded-2xl bg-[#ffffff] dark:bg-[#161616] border border-slate-200 dark:border-zinc-800 hover:border-slate-300 dark:hover:border-zinc-600 hover:shadow-sm transition-all h-full">
              <div class="w-10 h-10 rounded-lg bg-indigo-50 dark:bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 flex items-center justify-center text-xl mb-4">
            ...
            <!-- Rewriter -->
            <a routerLink="/docs/rewriter" class="!no-underline group flex flex-col p-5 rounded-2xl bg-[#ffffff] dark:bg-[#161616] border border-slate-200 dark:border-zinc-800 hover:border-slate-300 dark:hover:border-zinc-600 hover:shadow-sm transition-all h-full">
              <div class="w-10 h-10 rounded-lg bg-indigo-50 dark:bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 flex items-center justify-center text-xl mb-4">
            ...
            <!-- Translator -->
            <a routerLink="/docs/translator" class="!no-underline group flex flex-col p-5 rounded-2xl bg-[#ffffff] dark:bg-[#161616] border border-slate-200 dark:border-zinc-800 hover:border-slate-300 dark:hover:border-zinc-600 hover:shadow-sm transition-all h-full">
            ...
            <!-- Language Detector -->
            <a routerLink="/docs/language-detector" class="!no-underline group flex flex-col p-5 rounded-2xl bg-[#ffffff] dark:bg-[#161616] border border-slate-200 dark:border-zinc-800 hover:border-slate-300 dark:hover:border-zinc-600 hover:shadow-sm transition-all h-full">
              <div class="w-10 h-10 rounded-lg bg-teal-50 dark:bg-teal-500/10 text-teal-600 dark:text-teal-400 flex items-center justify-center text-xl mb-4">
            ...
            <!-- Proofreader -->
            <a routerLink="/docs/proofreader" class="!no-underline group flex flex-col p-5 rounded-2xl bg-[#ffffff] dark:bg-[#161616] border border-slate-200 dark:border-zinc-800 hover:border-slate-300 dark:hover:border-zinc-600 hover:shadow-sm transition-all h-full">
        ...
        <div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <!-- Privacy -->
            <div class="bg-slate-50 dark:bg-[#161616]/50 p-5 rounded-xl border border-slate-200 dark:border-zinc-800/80">
